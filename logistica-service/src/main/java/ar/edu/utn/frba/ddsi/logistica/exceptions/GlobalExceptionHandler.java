package ar.edu.utn.frba.ddsi.logistica.exceptions;
...
public class GlobalExceptionHandler {
    ...
    // 400 — parámetro de ruta con tipo inválido (ej: id no numérico)
    @ExceptionHandler(MethodArgumentTypeMismatchException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public Map<String, String> handleTypeMismatch(MethodArgumentTypeMismatchException e) {
        return Map.of("error", "Parámetro inválido: " + e.getName());
    }
